...
executable:/data/app/redis_master/bin/redis-server
config_file:/data/app/redis_master/conf/redis.conf #cluster配置文件
...
connected_slaves:1
slave0:ip=192.168.1.57,port=10064,state=online,offset=674295829,lag=0
slave0:ip=192.168.1.57,port=10065,state=online,offset=674295829,lag=0
